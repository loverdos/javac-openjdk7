...
package openjdk7.com.sun.source.util;
...
import openjdk7.com.sun.source.tree.ClassTree;
import openjdk7.com.sun.source.tree.CompilationUnitTree;
import openjdk7.com.sun.source.tree.MethodTree;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        if (!task.getClass().getName().equals("openjdk7.com.sun.tools.javac.api.JavacTaskImpl"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("openjdk7.com.sun.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    private static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("openjdk7.com.sun.tools.javac.api.JavacTrees", false, cl);
