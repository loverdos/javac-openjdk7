...
package openjdk7.com.sun.tools.javac;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
      if (args.length > 0 && args[0].equals("-Xjdb")) {
        ...
        Class<?> c = Class.forName("openjdk7.com.sun.tools.example.debug.tty.TTY");
        Method method = c.getDeclaredMethod ("main", new Class<?>[] {args.getClass()});
        method.setAccessible(true);
        System.arraycopy(args, 1, newargs, 3, args.length - 1);
        newargs[0] = "-connect";
        newargs[1] = "openjdk7.com.sun.jdi.CommandLineLaunch:options=-esa -ea:openjdk7.com.sun.tools...";
        newargs[2] = "openjdk7.com.sun.tools.javac.Main";
    ...
    public static int compile(String[] args) {
        openjdk7.com.sun.tools.javac.main.Main compiler =
            new openjdk7.com.sun.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        openjdk7.com.sun.tools.javac.main.Main compiler =
            new openjdk7.com.sun.tools.javac.main.Main("javac", out);
        return compiler.compile(args);
    }
}
