...
import openjdk7.com.sun.tools.javac.file.CacheFSInfo;
...
import openjdk7.com.sun.tools.javac.main.RecognizedOptions.OptionHelper;
import openjdk7.com.sun.tools.javac.util.*;
import openjdk7.com.sun.tools.javac.processing.AnnotationProcessingError;
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "openjdk7.com.sun.tools.javac.Main";
            showClass(showClass);
        }
