...
package openjdk7.com.sun.tools.javac.file;
...
import openjdk7.com.sun.tools.javac.file.RelativePath.RelativeDirectory;
import openjdk7.com.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized openjdk7.com.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            openjdk7.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return openjdk7.com.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            openjdk7.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private openjdk7.com.sun.tools.javac.util.List<String> zipFileEntriesFiles = openjdk7.com.sun.tools.javac.util.List.<String>nil();
        private openjdk7.com.sun.tools.javac.util.List<String> zipFileEntriesDirectories = openjdk7.com.sun.tools.javac.util.List.<String>nil();
        private openjdk7.com.sun.tools.javac.util.List<Entry>  zipFileEntries = openjdk7.com.sun.tools.javac.util.List.<Entry>nil();
        ...
        private openjdk7.com.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private openjdk7.com.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private openjdk7.com.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = openjdk7.com.sun.tools.javac.util.List.nil();
