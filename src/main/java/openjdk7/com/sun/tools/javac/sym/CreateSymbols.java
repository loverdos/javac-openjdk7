...
package openjdk7.com.sun.tools.javac.sym;

import openjdk7.com.sun.tools.javac.api.JavacTaskImpl;
import openjdk7.com.sun.tools.javac.code.Kinds;
import openjdk7.com.sun.tools.javac.code.Scope;
import openjdk7.com.sun.tools.javac.code.Symbol.*;
import openjdk7.com.sun.tools.javac.code.Symbol;
import openjdk7.com.sun.tools.javac.code.Attribute;
import openjdk7.com.sun.tools.javac.code.Symtab;
import openjdk7.com.sun.tools.javac.code.Type;
import openjdk7.com.sun.tools.javac.jvm.ClassReader;
import openjdk7.com.sun.tools.javac.jvm.ClassWriter;
import openjdk7.com.sun.tools.javac.jvm.Pool;
import openjdk7.com.sun.tools.javac.processing.JavacProcessingEnvironment;
import openjdk7.com.sun.tools.javac.util.List;
import openjdk7.com.sun.tools.javac.util.Pair;
 ...
 *
 * <dl>
 * <dt>openjdk7.com.sun.tools.javac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>openjdk7.com.sun.tools.javac.sym.Dest</dt>
 ...
 */
@SupportedOptions({"openjdk7.com.sun.tools.javac.sym.Jar","openjdk7.com.sun.tools.javac.sym.Dest"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("openjdk7.com.sun.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = processingEnv.getOptions().get("openjdk7.com.sun.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Aopenjdk7.com.sun.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = processingEnv.getOptions().get("openjdk7.com.sun.tools.javac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Aopenjdk7.com.sun.tools.javac.sym.Dest=LOCATION_OF_JAR");
        ...
        openjdk7.com.sun.tools.javac.main.JavaCompiler compiler =
            openjdk7.com.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "openjdk7.com.sun.tools.javac.sym.CreateSymbols",
            "-Aopenjdk7.com.sun.tools.javac.sym.Jar=" + rt_jar,
            "-Aopenjdk7.com.sun.tools.javac.sym.Dest=" + dest,
            ...
            "org.xml.sax.ext",
            "org.xml.sax.helpers",
            "openjdk7.com.sun.java.browser.dom",
            "org.w3c.dom",
            "org.w3c.dom.bootstrap",
            "org.w3c.dom.ls",
            "org.w3c.dom.ranges",
            ...
            "org.w3c.dom.events",
            "org.w3c.dom.views",
            "openjdk7.com.sun.management",
            "openjdk7.com.sun.security.auth",
            "openjdk7.com.sun.security.auth.callback",
            "openjdk7.com.sun.security.auth.login",
            "openjdk7.com.sun.security.auth.module",
            "openjdk7.com.sun.security.jgss",
            "openjdk7.com.sun.net.httpserver",
            "openjdk7.com.sun.net.httpserver.spi",
            "javax.smartcardio"
            // </editor-fold>
        };
        openjdk7.com.sun.tools.javac.Main.compile(args);
    }
