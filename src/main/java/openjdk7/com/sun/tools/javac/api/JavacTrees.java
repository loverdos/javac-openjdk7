...
package openjdk7.com.sun.tools.javac.api;
...
import openjdk7.com.sun.source.tree.CatchTree;
import openjdk7.com.sun.source.tree.CompilationUnitTree;
import openjdk7.com.sun.source.tree.Scope;
import openjdk7.com.sun.source.tree.Tree;
import openjdk7.com.sun.source.util.SourcePositions;
import openjdk7.com.sun.source.util.TreePath;
import openjdk7.com.sun.source.util.Trees;
import openjdk7.com.sun.tools.javac.code.Flags;
import openjdk7.com.sun.tools.javac.code.Symbol.ClassSymbol;
import openjdk7.com.sun.tools.javac.code.Symbol.TypeSymbol;
import openjdk7.com.sun.tools.javac.code.Symbol;
import openjdk7.com.sun.tools.javac.code.Type.UnionClassType;
import openjdk7.com.sun.tools.javac.comp.Attr;
import openjdk7.com.sun.tools.javac.comp.AttrContext;
import openjdk7.com.sun.tools.javac.comp.Enter;
import openjdk7.com.sun.tools.javac.comp.Env;
import openjdk7.com.sun.tools.javac.comp.MemberEnter;
import openjdk7.com.sun.tools.javac.comp.Resolve;
import openjdk7.com.sun.tools.javac.model.JavacElements;
import openjdk7.com.sun.tools.javac.processing.JavacProcessingEnvironment;
import openjdk7.com.sun.tools.javac.tree.JCTree.*;
import openjdk7.com.sun.tools.javac.tree.JCTree;
import openjdk7.com.sun.tools.javac.tree.TreeCopier;
import openjdk7.com.sun.tools.javac.tree.TreeInfo;
import openjdk7.com.sun.tools.javac.tree.TreeMaker;
import openjdk7.com.sun.tools.javac.util.Context;
import openjdk7.com.sun.tools.javac.util.JCDiagnostic;
...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof openjdk7.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (openjdk7.com.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof openjdk7.com.sun.tools.javac.code.Type.ErrorType) {
            return ((openjdk7.com.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return openjdk7.com.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            openjdk7.com.sun.source.tree.Tree t,
            openjdk7.com.sun.source.tree.CompilationUnitTree root) {
