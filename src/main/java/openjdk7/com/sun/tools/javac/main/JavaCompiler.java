...
package openjdk7.com.sun.tools.javac.main;
...
import openjdk7.com.sun.tools.javac.code.Lint.LintCategory;
...
import openjdk7.com.sun.tools.javac.processing.*;
...
import static openjdk7.com.sun.tools.javac.util.ListBuffer.lb;
...
public class JavaCompiler implements ClassReader.SourceCompleter {
    ...
    private static final String versionRBName = "openjdk7.com.sun.tools.javac.resources.version";
...
//      System.err.println("completing " + c);//DEBUG
   ...
   public List<JCCompilationUnit> parseFiles(Iterable<JavaFileObject> fileObjects) {
    ...
    public static void enableLogging() {
        Logger logger = Logger.getLogger(openjdk7.com.sun.tools.javac.Main.class.getPackage().getName());
