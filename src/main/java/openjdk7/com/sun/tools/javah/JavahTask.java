...
package openjdk7.com.sun.tools.javah;
...
import openjdk7.com.sun.tools.javac.main.CommandLine;
...
//                throw new BadArgs("jni.no.stubs");
    ...
    private static final String versionRBName = "openjdk7.com.sun.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("openjdk7.com.sun.tools.javah.resources.l10n", locale);
