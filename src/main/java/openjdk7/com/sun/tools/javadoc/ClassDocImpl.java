...
import static openjdk7.com.sun.javadoc.LanguageVersion.*;
...
import openjdk7.com.sun.tools.javac.tree.JCTree.JCClassDecl;
import openjdk7.com.sun.tools.javac.tree.JCTree.JCFieldAccess;
import openjdk7.com.sun.tools.javac.tree.JCTree.JCImport;
import openjdk7.com.sun.tools.javac.tree.TreeInfo;

import openjdk7.com.sun.tools.javac.util.List;
import openjdk7.com.sun.tools.javac.util.ListBuffer;
...
public class ClassDocImpl extends ProgramElementDocImpl implements ClassDoc {
     ...
     */
    public openjdk7.com.sun.javadoc.Type superclassType() {
     ...
     * Return an empty array if there are no interfaces.
     */
    public openjdk7.com.sun.javadoc.Type[] interfaceTypes() {
        //### Cache result here?
