...
import openjdk7.com.sun.tools.javac.code.Type.TypeVar;
import openjdk7.com.sun.tools.javac.code.Type.ArrayType;
...
public class TypeMaker {
    ...
    public static openjdk7.com.sun.javadoc.Type getType(DocEnv env, Type t) {
     ...
     */
    public static openjdk7.com.sun.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new openjdk7.com.sun.javadoc.Type[ts.length()]);
    }
     ...
     */
    public static openjdk7.com.sun.javadoc.Type[] getTypes(DocEnv env, List<Type> ts,
                                                  openjdk7.com.sun.javadoc.Type res[]) {
        int i = 0;
        for (Type t : ts) {
            res[i++] = getType(env, t);
        }
    ...
    private static class ArrayTypeImpl implements openjdk7.com.sun.javadoc.Type {
        ...
        private openjdk7.com.sun.javadoc.Type skipArraysCache = null;

        private openjdk7.com.sun.javadoc.Type skipArrays() {
