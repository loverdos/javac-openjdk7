...
import openjdk7.com.sun.mirror.apt.Filer;
...
import static openjdk7.com.sun.mirror.apt.Filer.Location.*;
...
public class FilerImpl implements Filer {
    ...
    private final openjdk7.com.sun.tools.apt.main.AptJavaCompiler comp;
    ...
    private FilerImpl(Context context) {
        ...
        comp = openjdk7.com.sun.tools.apt.main.AptJavaCompiler.instance(context);
        roundOver = false;
