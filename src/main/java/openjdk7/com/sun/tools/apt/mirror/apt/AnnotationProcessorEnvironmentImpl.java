...
package openjdk7.com.sun.tools.apt.mirror.apt;

import openjdk7.com.sun.mirror.declaration.*;
import openjdk7.com.sun.mirror.util.*;
import openjdk7.com.sun.mirror.apt.*;
import openjdk7.com.sun.tools.apt.mirror.apt.*;
import openjdk7.com.sun.tools.apt.mirror.declaration.DeclarationMaker;
import openjdk7.com.sun.tools.apt.mirror.util.*;
...
import openjdk7.com.sun.tools.apt.mirror.apt.MessagerImpl;
import openjdk7.com.sun.tools.apt.mirror.apt.RoundStateImpl;
import openjdk7.com.sun.tools.apt.mirror.apt.RoundCompleteEventImpl;

import openjdk7.com.sun.tools.javac.util.Context;

import java.util.*;
import static openjdk7.com.sun.mirror.util.DeclarationVisitors.*;
