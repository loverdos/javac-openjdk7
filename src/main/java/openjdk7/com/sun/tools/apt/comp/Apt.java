...
package openjdk7.com.sun.tools.apt.comp;

import openjdk7.com.sun.tools.javac.code.*;
import openjdk7.com.sun.tools.javac.comp.*;
import openjdk7.com.sun.tools.javac.tree.*;
import openjdk7.com.sun.tools.javac.util.*;
import openjdk7.com.sun.tools.javac.tree.TreeScanner;
import openjdk7.com.sun.tools.javac.util.Context;
import openjdk7.com.sun.tools.apt.util.Bark;
import openjdk7.com.sun.tools.javac.util.Position;
...
import openjdk7.com.sun.tools.apt.*;
import openjdk7.com.sun.tools.apt.comp.*;
import openjdk7.com.sun.tools.javac.code.Symbol.*;

import openjdk7.com.sun.mirror.declaration.TypeDeclaration;
import openjdk7.com.sun.mirror.declaration.AnnotationTypeDeclaration;
import openjdk7.com.sun.mirror.apt.*;
// import openjdk7.com.sun.mirror.apt.AnnotationProcessorFactory;
import openjdk7.com.sun.mirror.apt.AnnotationProcessors;

import openjdk7.com.sun.tools.apt.mirror.AptEnv;
import openjdk7.com.sun.tools.apt.mirror.apt.FilerImpl;
import openjdk7.com.sun.tools.apt.mirror.apt.AnnotationProcessorEnvironmentImpl;


import static openjdk7.com.sun.tools.apt.mirror.declaration.DeclarationMaker.isJavaIdentifier;
...
public class Apt extends ListBuffer<Env<AttrContext>> {
    ...
    public void main(openjdk7.com.sun.tools.javac.util.List<JCTree.JCCompilationUnit> treeList,
    ...
    Pattern importStringToPattern(String s) {
        if (openjdk7.com.sun.tools.javac.processing.JavacProcessingEnvironment.isValidImportString(s)) {
            return openjdk7.com.sun.tools.javac.processing.JavacProcessingEnvironment.validImportStringToPattern(s);
        } else {
            Bark bark = Bark.instance(context);
            bark.aptWarning("MalformedSupportedString", s);
            return openjdk7.com.sun.tools.javac.processing.JavacProcessingEnvironment.noMatches;
        }
    }
}
