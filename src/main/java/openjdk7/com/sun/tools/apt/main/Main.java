...
package openjdk7.com.sun.tools.apt.main;
...
import openjdk7.com.sun.tools.javac.code.Source;
...
import openjdk7.com.sun.tools.apt.comp.AnnotationProcessingError;
import openjdk7.com.sun.tools.apt.comp.UsageMessageNeededException;
import openjdk7.com.sun.tools.apt.util.Bark;
import openjdk7.com.sun.mirror.apt.AnnotationProcessorFactory;

import static openjdk7.com.sun.tools.javac.file.Paths.pathToURLs;
...
public class Main {
    ...
    public int compile(String[] args, AnnotationProcessorFactory factory) {
        ...
        if (options.get("-nocompile") == null &&
            ...
            returnCode = openjdk7.com.sun.tools.javac.Main.compile(newArgs);
        }
    ...
    private static final String javacRB =
        "openjdk7.com.sun.tools.javac.resources.javac";

    private static final String aptRB =
        "openjdk7.com.sun.tools.apt.resources.apt";
