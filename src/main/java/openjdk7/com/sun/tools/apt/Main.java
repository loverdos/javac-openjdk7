...
package openjdk7.com.sun.tools.apt;
...
public class Main {
    ...
    static {
        ...
        if (loader != null)
            loader.setPackageAssertionStatus("openjdk7.com.sun.tools.apt", true);
    }
    ...
    private static int processing(AnnotationProcessorFactory factory,
        ...
        openjdk7.com.sun.tools.apt.main.Main compiler =
            new openjdk7.com.sun.tools.apt.main.Main("apt", out);
