...
package openjdk7.com.sun.tools.apt.util;

import openjdk7.com.sun.tools.javac.util.Context;
import openjdk7.com.sun.tools.javac.util.JCDiagnostic;
import openjdk7.com.sun.tools.javac.util.JCDiagnostic.SimpleDiagnosticPosition;
...
public class Bark extends Log {
    ...
    protected Bark(Context context) {
        ...
        aptMessages.add("openjdk7.com.sun.tools.apt.resources.apt");
